...
strings = [
    ...
    (0xDD21+7*10, 'scramble'                        , 6, 'VIS'   ),
    (0xDD21+7*11, 'busy channel ptt lock'           , 6, 'CSMA'  ),
    ...
    (0xDD21+7*44, 'power on screen'                 , 6, 'MOTD'  ),
    ...
    (0xDD21+7*56, 'enable scrambler option'         , 6, 'VIS En'),
    ...
    (0xDEFE+4*1 , 'voice prompt: chinese'           , 3, 'CN'    ),
